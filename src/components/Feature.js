      ...
      <Container>
        <Row>
          <Col md={12} lg={6} className="mb-5 mt-5 p-4 featureLeft">
            ...
            <p className=" mb-1 default-color  font-bold mt-2 ">C3S NFT</p>
            ...
            <span className="font-xl white-color cursor-pointer pb-2">
              <a
                href="https://discord.gg/XqeDHe8f"
                target="_blank"
                className="pr-4 joinUs"
              >
                Join Us
              </a>
              <span style={{ width: 20, display: "inline-block" }} />
              <FaArrowRight className="text-orange"></FaArrowRight>
            </span>
          </Col>
          <Col lg={1} />
