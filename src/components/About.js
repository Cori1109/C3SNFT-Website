            ...
            <Col lg={5} md={12}>
              <Row>
                <Col lg={6} md={6} sm={6} xs={6} className="mb-3 customPadding">
                  <Image src="images/1.png" className="w-100 " rounded />
                </Col>
                <Col lg={6} md={6} sm={6} xs={6} className="mb-3 customPadding">
                  <Image src="images/2.png" className="w-100" rounded />
                </Col>
                <Col lg={6} md={6} sm={6} xs={6} className="mb-3 customPadding">
                  <Image src="images/3.png" className="w-100" rounded />
                </Col>
                <Col lg={6} md={6} sm={6} xs={6} className="mb-3 customPadding">
                  <Image src="images/4.png" className="w-100" rounded />
                </Col>
              </Row>
            </Col>
            <Col lg={7} className="p-4">
              <div className="text-white">
                ...
                <p className="mt-4 mb-0 font-lgr aboutTxt">
                  The <b className="text-orange">first C3S NFT</b> collection
                  will be the Layer 1 Society. There will be a total amount of
                  5439 <b>unique NFTs</b>.
                </p>
                ...
                <p className="aboutTxt">
                  The <b className="text-orange">C3S NFT</b> is a community of
